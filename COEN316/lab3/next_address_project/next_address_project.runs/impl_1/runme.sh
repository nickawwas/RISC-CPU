...
HD_PWD='/nfs/home/n/n_kawwas/COEN316/lab3/next_address_project/next_address_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log next_address_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source next_address_board.tcl -notrace
