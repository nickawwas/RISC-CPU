...
HD_PWD='/nfs/home/n/n_kawwas/COEN316/lab3/next_address_project/next_address_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log next_address_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source next_address_board.tcl
